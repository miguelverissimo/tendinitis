...
let s:p.insert.left = [[["#132122", 234], ["#b2dfa8", 151]], [["#132122", 234], ["#aadc9f", 151]]]
let s:p.insert.middle = [[["#132122", 234], ["#99c68f", 114]]]
let s:p.insert.right = [[["#132122", 234], ["#b2dfa8", 151]], [["#132122", 234], ["#aadc9f", 151]]]

let s:p.replace.left = [[["#132122", 234], ["#d96879", 168]], [["#132122", 234], ["#ca2c43", 161]]]
let s:p.replace.middle = [[["#132122", 234], ["#c5152f", 160]]]
let s:p.replace.right = [[["#132122", 234], ["#d96879", 168]], [["#132122", 234], ["#ca2c43", 161]]]

let s:p.visual.left = [[["#132122", 234], ["#fadd6e", 221]], [["#132122", 234], ["#fada5e", 221]]]
let s:p.visual.middle = [[["#132122", 234], ["#e1c454", 185]]]
let s:p.visual.right = [[["#132122", 234], ["#fadd6e", 221]], [["#132122", 234], ["#fada5e", 221]]]

let s:p.tabline.left = [[["#b3b6a3", 249], ["#949382", 246]]]
let s:p.tabline.tabsel = [[["#132122", 234], ["#b3b6a3", 249]]]
let s:p.tabline.middle = [[["#132122", 234], ["#7b7a69", 243]]]
