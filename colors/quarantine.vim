...
hi IncSearch guifg=#2b3e50 ctermfg=237 guibg=#ffffff ctermbg=15 gui=NONE cterm=NONE
...
hi Normal guifg=#e1e0cf ctermfg=253 guibg=#2b3e50 ctermbg=237 gui=NONE cterm=NONE
hi PMenu guifg=#e1e0cf ctermfg=253 guibg=#334152 ctermbg=238 gui=NONE cterm=NONE
hi PMenuSel guifg=#2b3e50 ctermfg=237 guibg=#ffc24b ctermbg=215 gui=NONE cterm=NONE
...
hi SpellCap guifg=#2b3e50 ctermfg=237 guibg=#ffc24b ctermbg=215 gui=NONE cterm=NONE
...
hi WildMenu guifg=#2b3e50 ctermfg=237 guibg=#b2dfa8 ctermbg=151 gui=Bold cterm=Bold
...
hi Define guifg=#087ca7 ctermfg=31 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
