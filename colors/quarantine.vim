...
hi CursorIM guifg=#223245 ctermfg=236 guibg=#e5ab00 ctermbg=178 gui=NONE cterm=NONE
...
hi IncSearch guifg=#223245 ctermfg=236 guibg=#ffffff ctermbg=15 gui=NONE cterm=NONE
...
hi Normal guifg=#e1e0cf ctermfg=253 guibg=#223245 ctermbg=236 gui=NONE cterm=NONE
hi PMenu guifg=#e1e0cf ctermfg=253 guibg=#334152 ctermbg=238 gui=NONE cterm=NONE
hi PMenuSel guifg=#223245 ctermfg=236 guibg=#ffc24b ctermbg=215 gui=NONE cterm=NONE
...
hi SpellCap guifg=#223245 ctermfg=236 guibg=#ffc24b ctermbg=215 gui=NONE cterm=NONE
...
hi WildMenu guifg=#223245 ctermfg=236 guibg=#b2dfa8 ctermbg=151 gui=Bold cterm=Bold
